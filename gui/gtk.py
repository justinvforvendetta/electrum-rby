...
from electrum_rby.util import print_error, InvalidPassword
from electrum_rby.bitcoin import is_valid
from electrum_rby import WalletStorage, Wallet

Gdk.threads_init()
APP_NAME = "Electrum-RBY"
import platform
MONOSPACE_FONT = 'Lucida Console' if platform.system() == 'Windows' else 'monospace'

from electrum_rby.util import format_satoshis, parse_URI
from electrum_rby.network import DEFAULT_SERVERS
from electrum_rby.bitcoin import MIN_RELAY_TX_FEE
...
class ElectrumWindow:
    ...
    def __init__(self, wallet, config, network):
        ...
        title = 'Electrum-RBY ' + self.wallet.electrum_version + '  -  ' + self.config.path
        ...
        from electrum_rby.util import StoreDict
    ...
    def do_send(self, w, data):
        ...
        if not is_valid(to_address):
            self.show_message( "invalid rubycoin address:\n"+to_address)
            return
