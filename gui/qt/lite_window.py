...
import re
import time
from electrum_rby.wallet import Wallet, WalletStorage
import webbrowser
...
from electrum_rby.version import ELECTRUM_VERSION as electrum_version
from electrum_rby.util import format_satoshis, age
...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        self.address_input.setPlaceholderText(_("Enter a RubyCoin address or contact"))
        ...
        self.setWindowTitle("Electrum-RBY")
    ...
    def the_website(self):
        webbrowser.open("http://electrum-rby.space")
