import time, electrum_rby as electrum, Queue
from electrum_rby import Interface, SimpleConfig
from electrum_rby.network import filter_protocol, parse_servers
...
def get_peers():
    ...
    q = Queue.Queue()
    interface = electrum.Interface('rby-cce-1.coinomi.net:5018:s', q)
    interface.start()
    i, r = q.get()
