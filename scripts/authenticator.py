...
imp.load_module('electrum_rby', *imp.find_module('lib'))

from electrum_rby import SimpleConfig, Wallet, WalletStorage, format_satoshis
from electrum_rby import util
from electrum_rby.transaction import Transaction
from electrum_rby.bitcoin import base_encode, base_decode
    ...
    content = """
      ...
      <LinearLayout 
        ...
        <TextView
          ...
          android:text="Electrum-RBY Authenticator"
...
class Authenticator:
    ...
    def __init__(self):
        global wallet
        self.qr_data = None
        storage = WalletStorage('/sdcard/electrum-rby/authenticator')
